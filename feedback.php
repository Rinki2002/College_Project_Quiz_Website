<!DOCTYPE html PUBLIC "-//W3//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1-transitional.dtd">
...
<div class="col-md-4">
    ...
    if((!isset($_SESSION['email']))){
        ...
        else
        {
            ...
            <a href="index.php" class="pull-right btn sub1 title3"><span class="glyphicon glyphcon-home" aria-hidden="true"></span>&nbsp;Home</a>&nbsp;
        </div></div>
        ...
        <div class="modal-body">
            <form class="form-horizontal" action="login.php?q=index.php" method="POST">
                ...
                <div class="form-group">
                    <label class="col-mod-3 control-label" for="email"></label>
                    <div class="col-md-6">
                        <input id="email" placeholder="Enter your email-id" class="form-control input-md" type="email">
                        </div>
</div>
